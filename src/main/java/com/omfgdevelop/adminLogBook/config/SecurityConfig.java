package com.omfgdevelop.adminLogBook.config;

import com.omfgdevelop.adminLogBook.security.jwt.JwtConfigurer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String REGISTER_ENDPOINT = "/api/v1/auth/**";
